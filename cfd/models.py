...
#The first element in each tuple is the actual value to be set on the model, and the second element is the human-readable name. For example:
    ...
    BIOSIMILAR_DISC = models.CharField('Biosimilar (Effective Discount)',max_length=50,choices=DROP_DOWN_MENU_24_CHOICES, default="TBD")
    IE_ADJUSTMENTS = models.CharField('Adjustments',max_length=50,choices=DROP_DOWN_MENU_24_CHOICES, default="TBD")
    ...
    IE_COB_SECONDARY_CLAIMS = models.CharField('COB/Secondary Claims',max_length=50,choices=DROP_DOWN_MENU_24_CHOICES, default="TBD")
    IE_COMPOUNDS = models.CharField('Compounds',max_length=50,choices=DROP_DOWN_MENU_24_CHOICES, default="TBD")
    IE_DAW_5 = models.CharField('DAW 5',max_length=52,choices=DROP_DOWN_MENU_25_CHOICES, default="TBD")
    IE_DMR_CLAIMS = models.CharField('Direct Member Reimbursement (DMR) Claims',max_length=50,choices=DROP_DOWN_MENU_24_CHOICES, default="TBD")
    IE_EXCLUDED_PROVIDERS = models.CharField('Excluded Providers (e.g. VA, I/T/U, nursing home, long-term care, in-house, on-site)',max_length=30,choices=DROP_DOWN_MENU_24_CHOICES, default="TBD")
    ...
    IE_NON_DRUG_ITEMS = models.CharField('Non Drug Items',max_length=50,choices=DROP_DOWN_MENU_24_CHOICES, default="TBD")
    IE_NON_MAC_GENERICS = models.CharField('Non-MAC Generics',max_length=37,choices=DROP_DOWN_MENU_25_CHOICES, default="TBD")
    IE_OTC = models.CharField('Over-The-Counter (OTC)',max_length=50,choices=DROP_DOWN_MENU_24_CHOICES, default="TBD")
    ...
    IE_PRICING_ERROR_THRESHOLDS = models.CharField('Pricing error thresholds (claims excluded from the analysis)',max_length=50,choices=DROP_DOWN_MENU_24_CHOICES, default="TBD")
    IE_REJECTS = models.CharField('Rejects',max_length=50,choices=DROP_DOWN_MENU_24_CHOICES, default="TBD")
    IE_REVERSALS = models.CharField('Reversals',max_length=50,choices=DROP_DOWN_MENU_24_CHOICES, default="TBD")
    IE_SSG = models.CharField('SSG',max_length=50,choices=DROP_DOWN_MENU_25_CHOICES, default="TBD")
    IE_SUBROGATION = models.CharField('Subrogation',max_length=50,choices=DROP_DOWN_MENU_24_CHOICES, default="TBD")
    IE_UAC = models.CharField('U&C',max_length=50,choices=DROP_DOWN_MENU_24_CHOICES, default="TBD")
    IE_ZBD = models.CharField('ZBD',max_length=50,choices=DROP_DOWN_MENU_24_CHOICES, default="TBD")
    LDD_DISC = models.DecimalField('LDD (Effective Discount)',max_digits=6, decimal_places=3, default=0)
    LDD_REBATE = models.CharField('LDD (Rebates)',max_length=50,choices=DROP_DOWN_MENU_24_CHOICES, default="TBD")
    ...
    OBSOLETE_NDCS = models.CharField('Obsolete NDCs',max_length=50,choices=DROP_DOWN_MENU_24_CHOICES, default="TBD")
