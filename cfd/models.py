...
#The first element in each tuple is the actual value to be set on the model, and the second element is the human-readable name. For example:
    ...
    GUAR_BR_IZBD_DCT = models.DecimalField('Retail Brand AWP Discount (including ZBDs)',max_digits=20, decimal_places=9)
    GUAR_BR_EZBD_DCT = models.DecimalField('Retail Brand AWP Discount (excluding ZBDs)',max_digits=20, decimal_places=9)
    GUAR_GR_IZBD_DCT = models.DecimalField('Retail Generic AWP Discount (including ZBDs)',max_digits=20, decimal_places=9)
    GUAR_GR_EZBD_DCT = models.DecimalField('Retail Generic AWP Discount (excluding ZBDs)',max_digits=20, decimal_places=9)
    GUAR_BR_DISP_FEE = models.DecimalField('Retail Brand Dispensing Fee',max_digits=20, decimal_places=9)
    GUAR_GR_DISP_FEE = models.DecimalField('Retail Generic Dispensing Fee',max_digits=20, decimal_places=9)
    GUAR_RETAIL_ADMIN_FEE = models.DecimalField('Retail Admin Fee',max_digits=20, decimal_places=9)
    GUAR_RETAIL_REBATE = models.DecimalField('     Rebate $',max_digits=20, decimal_places=9)
    GUAR_BR90_IZBD_DCT = models.DecimalField('Retail-90 Brand AWP Discount (including ZBDs)',max_digits=20, decimal_places=9)
    GUAR_BR90_EZBD_DCT = models.DecimalField('Retail-90 Brand AWP Discount (excluding ZBDs)',max_digits=20, decimal_places=9)
    GUAR_GR90_IZBD_DCT = models.DecimalField('Retail-90 Generic AWP Discount (including ZBDs)',max_digits=20, decimal_places=9)
    GUAR_GR90_EZBD_DCT = models.DecimalField('Retail-90 Generic AWP Discount (excluding ZBDs)',max_digits=20, decimal_places=9)
    GUAR_BR90_DISP_FEE = models.DecimalField('Retail-90 Brand Dispensing Fee',max_digits=20, decimal_places=9)
    GUAR_GR90_DISP_FEE = models.DecimalField('Retail-90 Generic Dispensing Fee',max_digits=20, decimal_places=9)
    GUAR_R90_ADMIN_FEE = models.DecimalField('Retail-90 Admin Fee',max_digits=20, decimal_places=9)
    GUAR_BM_IZBD_DCT = models.DecimalField('Mail Brand AWP Discount (including ZBDs)',max_digits=20, decimal_places=9)
    GUAR_BM_EZBD_DCT = models.DecimalField('Mail Brand AWP Discount (excluding ZBDs)',max_digits=20, decimal_places=9)
    GUAR_GM_IZBD_DCT = models.DecimalField('Mail Generic AWP Discount (including ZBDs)',max_digits=20, decimal_places=9)
    GUAR_GM_EZBD_DCT = models.DecimalField('Mail Generic AWP Discount (excluding ZBDs)',max_digits=20, decimal_places=9)
    GUAR_BM_DISP_FEE = models.DecimalField('Mail Brand Dispensing Fee',max_digits=20, decimal_places=9)
    GUAR_GM_DISP_FEE = models.DecimalField('Mail Generic Dispensing Fee',max_digits=20, decimal_places=9)
    GUAR_MAIL_ADMIN_FEE = models.DecimalField('Mail Admin Fee',max_digits=20, decimal_places=9)
    GUAR_SPC_BR_DCT = models.DecimalField('Specialty Brand AWP Discount - Retail',max_digits=20, decimal_places=9)
    GUAR_SPC_GR_DCT = models.DecimalField('Specialty Generic AWP Discount - Retail',max_digits=20, decimal_places=9)
    GUAR_SPC_BR_DISP_FEE = models.DecimalField('Specialty Brand Dispensing Fee - Retail',max_digits=20, decimal_places=9)
    GUAR_SPC_GR_DISP_FEE = models.DecimalField('Specialty Generic Dispensing Fee - Retail',max_digits=20, decimal_places=9)
    GUAR_SPC_RETAIL_ADMIN_FEE = models.DecimalField('Specialty Admin Fee - Retail',max_digits=20, decimal_places=9)
    GUAR_SPC_SRX_B_DCT = models.DecimalField('Specialty Brand AWP Discount - SRx',max_digits=20, decimal_places=9)
    GUAR_SPC_SRX_G_DCT = models.DecimalField('Specialty Generic AWP Discount - SRx',max_digits=20, decimal_places=9)
    GUAR_SPC_G_SRX_DISP_FEE = models.DecimalField('Specialty Generic Dispensing Fee - SRx',max_digits=20, decimal_places=9)
    GUAR_SPC_B_SRX_DISP_FEE = models.DecimalField('Specialty Brand Dispensing Fee - SRx',max_digits=20, decimal_places=9)
    GUAR_SPC_SRX_ADMIN_FEE = models.DecimalField('Specialty Admin Fee - SRx',max_digits=20, decimal_places=9)
    ...
    LDD_DISC = models.DecimalField('LDD (Effective Discount)',max_digits=20, decimal_places=9)
